...
const ExpenseForm = (props) => {
    ...
    const titleChangeHandler = (event) => {
        ...
        // This approach is not safe as React schedules all the setStates...so there is a chance that the userInput variable might not have the latest updated state in it
        // setUserInput({
        //     ...userInput,
        //     enteredTitle: event.target.value
        // })
        // This approach ensures that which executing this setState you certainly receive the previous state
